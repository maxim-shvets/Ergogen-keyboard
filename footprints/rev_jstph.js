// Took the original JSTPH fp from the ergogen source,
// just added silkscreen markings to both sides
//
// NOTE: WILL REQUIRE REPINNING CONNECTORS ON BATTERIES TO MAKE
// SURE B+ IS ALWAYS ROUTED TO B+. ALWAYS DOUBLE CHECK POLARITY.
